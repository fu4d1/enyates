...
<html>
    ...
    <body>
	    ...
	    <div class="form-group">
            <label for="int">Group Level Id <?php echo form_error('group_level_id') ?></label>
            <input type="text" class="form-control" name="group_level_id" id="group_level_id" placeholder="Group Level Id" value="<?php echo $group_level_id; ?>" />
        </div>
